...
class NewTaskListDialog extends StatefulWidget {
  final String groupListID;

  const NewTaskListDialog({Key? key, required this.groupListID})
      : super(key: key);

  @override
  _NewTaskListDialogState createState() => _NewTaskListDialogState();
}

class _NewTaskListDialogState extends State<NewTaskListDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      insetPadding: EdgeInsets.symmetric(horizontal: (MediaQuery.of(context).size.width > 1500) ? 600 : 300),
      child: Padding(
